...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$BUILT_PRODUCTS_DIR/PDKeychainBindingsController/PDKeychainBindingsController.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/iOS_AylaSDK/iOS_AylaSDK.framework"
fi
