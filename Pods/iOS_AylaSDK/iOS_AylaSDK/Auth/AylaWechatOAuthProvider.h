...
/**
 ...
 It passes authCode received from Wechat to Ayla User Service for login account validation.
 The response received from Ayla User Service is converted to AylaAuthorization object.
 */
@interface AylaWechatOAuthProvider : AylaBaseAuthProvider
...
/**
 ...
 @return An `AylaWechatOAuthProvider` instance, initialized with the specified `authCode`
 */
