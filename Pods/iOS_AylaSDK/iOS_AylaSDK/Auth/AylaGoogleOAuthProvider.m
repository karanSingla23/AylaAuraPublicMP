...
@interface AylaGoogleOAuthProvider ()
...
@implementation AylaGoogleOAuthProvider

+ (instancetype)providerWithAuthCode:(NSString *)authCode
{
    AylaGoogleOAuthProvider *provider = [[self alloc] init];
...
- (AylaHTTPTask *)authenticateAgainstServiceWithCode:(NSString *)code
{
    ...
    NSDictionary *params = @{
        ...
        @"provider" : AylaOAuthTypeNameGoogle
    };
...
- (NSString *)logTag
{
    return NSStringFromClass([AylaGoogleOAuthProvider class]);
}
